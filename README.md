...
- 🖌️ Frame customization: Add text labels and style the frame around your QR code. Captions wrap to match the preview in exports, and side captions have an adjustable width (% of QR size)
