...
- 🖌️ Frame customization: Add text labels and style the frame around your QR code. Captions wrap to match the preview in exports, and side captions have an adjustable width. The frame background can be a solid color or an uploaded image (persisted locally and included in PNG/JPG/SVG exports)
